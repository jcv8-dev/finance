          ...
          <form name="neueBuchungForm">
              ...
              <div class="row">
                  ...
                  <div class="col-md-3 col-sm-4 px-1">
                      <button type="button" onclick="insertBuchung(false);" class="btn btn-outline-primary w-100 shadow-box-sm" id="submit-ausgabe">Ausgabe buchen</button>
                  </div>
              </div>
          </form>
      </div>
          ...
          <form>
              <div class="row">
                  ...
                  <div class="col-3 px-1">
                      <button type="button" id="submit-filter" onclick="submitFilter(false)" class="btn btn-outline-primary w-100 shadow-box-sm">Anwenden</button>
                  </div>
              </div>
          </form>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button id="deleteBuchung" type="button" onclick="notImplemented()" class="btn btn-outline-danger">Löschen</button>
                        <button id="submitEditBuchung" type="button" onclick="" class="btn btn-primary">Speichern</button>
                    </div>
                </div>
            </div>
        </div>
